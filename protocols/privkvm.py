...
def privkvm(epsilon, users_data, realfres, realmeans):
    ...
    print(f"fre_mses:{fre_mses / 100}")
    print(f"mean_mses:{mean_mses / 100}")
    return fre_mses / 100, mean_mses / 100
...
if __name__ == "__main__":
    ...
    res_fre, res_mean = [],[]
    for ep in [0.25,0.5,1,2,3,4]:
        a,b = privkvm(ep, user_data, real_fres, real_means) #
        res_fre.append(a)
        res_mean.append(b)
    print(res_fre)
    print(res_mean)
