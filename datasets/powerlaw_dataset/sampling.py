    ...
    try:
        with open(FILE_PATH, 'r') as f:
            ...
            for line in pbar:
                ...
                sample_index = random.randint(0, 50)
...
def padding_and_sampling(output_txt_path, fill_len=7, pad_start=100, missing_value=-10):
    """
...
if __name__ == "__main__":
    ...
    padding_and_sampling("padding_and_sampling.txt",fill_len=6,pad_start=100,missing_value=10)